...
public class FormularioAdapterIP extends RecyclerView.Adapter<FormularioAdapterIP.MyViewHolder> {
    public int contadorIPLayout;
    public FormularioAdapterIP( int contadorIPLayout) {
        this.contadorIPLayout = contadorIPLayout;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemLista = LayoutInflater.from(parent.getContext())
                                        .inflate(R.layout.fragment_cadastro_ip, parent, false);
